...
export class GetVideosService {
  ...
  getAllUserVideos(userId:any): Observable<Array<Video>> {
    return this.http.get<Array<Video>>(`http://localhost:8080/getAllUserVideos/${userId}`);
  }
  ...
  getVideoCategory(catId: any) {
    return this.http.get<Array<Video>>(`http://localhost:8080/getVideosByCat/${catId}`);
    // return this.http.get<Array<Video>>(`http://localhost:8080/getVideoByCat/${categoryId}`);
  }
  ...
  reportVideo (videoId : number, userId : number) {
    return this.http.get<any>(`http://localhost:8080/reportVideo/${videoId}/${userId}`);
  }

  deleteVideo (videoId : number){
    return this.http.post<any>(`http://localhost:8080/deleteVid/${videoId}`,videoId);
  }
